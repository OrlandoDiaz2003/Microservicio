...
public class ProductoControllerV2 {
    ...
    public CollectionModel<EntityModel<Producto>> mostrarProductos(){
        ...
        linkTo(methodOn(ProductoControllerV2.class).mostrarProductos()).withSelfRel());
    } 
   
    @GetMapping(value = "/buscarPorid/{id}", produces = MediaTypes.HAL_JSON_VALUE)
    public EntityModel<Producto> buscarPorId(@PathVariable int id){
    ...
    public CollectionModel<EntityModel<Producto>> buscarPorNombre(@PathVariable String nombre){
        ...
        return CollectionModel.of(productos,linkTo(methodOn(ProductoControllerV2.class).buscarPorNombre(nombre)).withSelfRel());
    }
    ...
    public CollectionModel<EntityModel<Producto>> buscarPorCategoria(@PathVariable String categoria){
        ...
        return CollectionModel.of(productos,linkTo(methodOn(ProductoControllerV2.class).buscarPorCategoria(categoria)).withSelfRel());
    }
}
